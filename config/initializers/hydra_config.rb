...
Hydra.configure do |config|
  ...
  # You only need to change these values if you've indexed permissions by
  # some means other than the Hydra's built-in tooling.
  # If you change these, you must also update the permissions request handler
  # in your solrconfig.xml to return those values
  #
  ...
  #   ActiveFedora::SolrQueryBuilder.solr_name('embargo_release_date', :stored_sortable, type: :date)
  # config.permissions.lease.expiration_date =
  #   ActiveFedora::SolrQueryBuilder.solr_name('lease_expiration_date', :stored_sortable, type: :date)
  #
  #
